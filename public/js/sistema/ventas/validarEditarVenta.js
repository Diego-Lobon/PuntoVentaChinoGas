if (document.getElementById('idCliente').value.trim() !== "") {
...
const inputNombreCliente = document.querySelector('#nombreCliente')
const selectVendedor = document.querySelector('#select_vendedor')
const inputDireccion = document.querySelector('#direccion')
const inputCelular = document.querySelector('#celular')
const inputCantidad = document.querySelector('#cantidad')
const selectProducto = document.querySelector('#select_producto')
const selectCliente = document.querySelector('#select_tipo_cliente')
const selectPago = document.querySelector('#select_tipo_pago')

validarCampo(expresiones.nombreCliente, inputNombreCliente, 'nombreCliente')
inputNombreCliente.classList.add("inputFocusActived");

validarSelect(selectVendedor, 'select_vendedor')
selectVendedor.classList.add("inputFocusActived");

validarCampo(expresiones.direccion, inputDireccion, 'direccion')
inputDireccion.classList.add("inputFocusActived");

validarCampo(expresiones.celular, inputCelular, 'celular')
inputCelular.classList.add("inputFocusActived");

validarCampo(expresiones.cantidad, inputCantidad, 'cantidad')
inputCantidad.classList.add("inputFocusActived");

validarSelect(selectProducto, 'select_producto')
selectProducto.classList.add("inputFocusActived");

validarSelect(selectCliente, 'select_tipo_cliente')
selectCliente.classList.add("inputFocusActived");

validarSelect(selectPago, 'select_tipo_pago')
selectPago.classList.add("inputFocusActived");
