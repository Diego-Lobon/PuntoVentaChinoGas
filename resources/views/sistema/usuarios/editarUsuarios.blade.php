...
<div class="container">
    ...
    <div class="form-usuarios">
        ...
        <div class="info_id">
            <span>ID Usuario: {{ $usuario[0]['id'] }}</span>
            <input id='idElemento' class='idElemento' value="{{ $usuario[0]['id'] }}">
        </div>
        <form action="{{ route('sistema.usuarios.update', $usuario[0]['id']) }}" method="POST" class="formulario" id="formulario">
            @csrf
            @method('put')
            <div class='input-fila1'>
                <div id="grupo__username">
                    <div>
                        <input class="formulario__input" id="username" name="username" type="text" value="{{ $usuario[0]['username'] }}">
            ...
            <div class='input-fila2'>
                <div id="grupo__nombreUsuario">
                    <div>
                        <input class="formulario__input" id="nombreUsuario" name="nombreUsuario" type="text" value="{{ $usuario[0]['nombre'] }}">
            ...
            <div class="input-fila3">
                <div id="grupo__password">
                    <div>
                        ...
                        <label class="formulario__label" for="">Contraseña Antigua</label>
                        <i class="formulario__validacion-estado fas fa-times-circle"></i>
                    </div>
                    ...
                    <p id="formulario__input-error2" class="formulario__input-error2">No es su contraseña actual.</p>
                </div>
            </div>
            <div class="input-fila4">
                <div id="grupo__password_new">
                    <div>
                        <input class="formulario__input" id="password_new" name="password_new" type="password">
                        <label class="formulario__label" for="">Nueva Contraseña</label>
                        <i class="formulario__validacion-estado fas fa-times-circle"></i>
                    </div>
                    <p class="formulario__input-error">La contraseña tiene que ser de 4 a 12 dígitos y no puede comenzar con espacio.</p>
                </div>
            </div>
            <div class="input-fila5">
                <div id="grupo__rol">
                    <div>
                        <input class="formulario__input" id="rol" name="rol" type="text" value="{{ $usuario[0]['rol'] }}">
...
<script src="{{ asset('js/sistema/usuarios/validarEditarUsuario.js') }}"></script>
