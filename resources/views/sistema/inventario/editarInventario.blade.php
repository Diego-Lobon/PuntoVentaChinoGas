...
<div class="container">
    ...
    <div class="form-producto">
        ...
        <div class="info_id">
            ...
            <input id='idElemento' class='idElemento' value='{{ $producto->id }}'>
        </div>
        <form action="{{ route('sistema.inventario.update', $producto) }}" method="POST" class="formulario" id="formulario">
            @csrf
            @method('put')
            <div class='input-fila1'>
                <div id="grupo__nombreProducto">
                    <div>
                        <input class="formulario__input" id="nombreProducto" name="nombreProducto" type="text" value="{{ $producto->nombreProducto }}">
                    ...
                    <p class="formulario__input-error2">Ya existe un producto con ese nombre.</p>
                </div>
                <div id="grupo__cantidad">
                    <div>
                        <input class="formulario__input" id="cantidad" name="cantidad" type="text" oninput="validarNumeroEntero(this)" value="{{ $producto->cantidad }}">
            ...
            <div class="input-fila2">
                <div id="grupo__precioCompra">
                    <div>
                        <input class="formulario__input" id="precioCompra" name="precioCompra" type="text" oninput="validarNumeroReal(this)" value="{{ $producto->precioCompra }}">
                ...
                <div id="grupo__precioVenta">
                    <div>
                        <input class="formulario__input" id="precioVenta" name="precioVenta" type="text" oninput="validarNumeroReal(this)" value="{{ $producto->precioVenta }}">
...
<script src="{{ asset('js/sistema/inventario/validarEditarInventario.js') }}"></script>
